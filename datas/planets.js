const planets = [
  { 
    ...
    infos2: 'Mercure est la plus petite planète du système solaire et la plus proche du Soleil. 🌑', 
  ...
  { 
    ...
    infos2: 'Vénus possède une atmosphère dense provoquant un effet de serre extrême. 🌡️', 
  ...
  { 
    ...
    infos: 'La Terre effectue une rotation complète en 24 heures, ce qui rythme le cycle jour-nuit. 🌍',
    infos2: 'La Terre est la seule planète connue à abriter la vie. 🌍',
  ...
  { 
    ...
    infos: 'Un jour sur Mars dure environ 24h37, presque comme sur Terre ! 🚀',
    infos2: 'Mars est la planète rouge et abrite le plus haut volcan du système solaire. 🚀',
  ...
  { 
    ...
    infos2: 'Jupiter est la plus grande planète et possède une énorme tempête appelée la Grande Tache Rouge. 🌪️',
  ...
  { 
    ...
    infos: 'Saturne a une rotation rapide : un jour dure environ 10h42. 💍',
    infos2: 'Saturne est célèbre pour ses magnifiques anneaux faits de glace et de roche. 💍',
  ...
  { 
    ...
    infos2: 'Uranus tourne presque sur le côté avec une inclinaison de 98°. 🌀',
  ...
  { 
    ...
    infos2: 'Neptune est la planète la plus lointaine et possède des vents ultra-rapides. 🌊',
