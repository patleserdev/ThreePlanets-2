  ...
  return (
    <div className={styles.container}>
      <div className={styles.boxContainer}>
        <div className={styles.boxLeftContainer}></div>

        <div className={styles.boxRightContainer}></div>

        <div className={styles.boxCenterContainer}>
...
>
  <Suspense fallback={null}>
    ...
    {/* <Constellations focus={focus} setFocus={setFocus} /> */}
  ...
  <OrbitControls enableZoom={true} enablePan={true} />
        ...
        <div className={styles.boxTopContainer}></div>

        <div className={styles.boxBottomContainer}></div>
      </div>
      ...
      {/* {selectedPlanet && focus != null && (
        <div className={styles.infoBox}>
          <h2>{selectedPlanet}</h2>
          <p>
            {constellations.find((constellation) => constellation.name === selectedPlanet)?.infos ||
